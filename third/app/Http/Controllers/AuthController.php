...
class AuthController extends Controller
{
    ...
    public function logout(Request $request)
    {
        ...
        // Fazer logout no second PRIMEIRO (antes de invalidar o token)
        ...
        if ($token && $user) {
            try {
                ...
                if ($response->successful()) {
                    Log::info('Logout no second realizado com sucesso do third para: ' . $user->email);
                } else {
                    Log::warning('Logout no second falhou do third: ' . $response->body());
                }
            } catch (Exception $e) {
